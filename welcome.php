...
?>
    ...
    <body id="index" class="home">
        ...
        <header id="banner" class="body">
            <h1><a href="#">Example <br><strong>The most intelligent way to improve vocabulary</strong></a></h1>
            <nav>
                <ul>
    ...
    ?>
        ...
        <section id="content" class="body">
            ...
            <article class="hentry">
                <header>
                    <h2 class="entry-title"><a href="#" rel="bookmark" title="Permalink to this Building a Pusher-powered Real-Time Commenting System">Example.com combines the world's smartest dictionary with an adaptive learning</a></h2>
                </header>

                <footer class="post-info">
                    <abbr class="published" title="2017-12-2T14:07:00-07:00">
					3rd Dec 2017
				</abbr>

                    <address class="vcard author">
					By <a class="url fn" href="#">Mynk</a>
				</address>
                </footer>
